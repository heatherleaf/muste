concrete GraspLexGer of GraspLex = GraspCatGer, LexiconGer [
  N, A, 
...
] ** open (L=LexiconGer), (P=ParadigmsGer), (S=StructuralGer), (I=IrregGer) in {
...
lin
  ...
  john_PN = P.mkPN "Johann" ;
  gothenburg_PN = P.mkPN "Göteburg" ;
  sweden_PN = P.mkPN "Schweden" ;
  london_PN = P.mkPN "London" ;
  britain_PN = P.mkPN "England" ;
  berlin_PN = P.mkPN "Berlin" ;
  germany_PN = P.mkPN "Deutschland" ;
...
oper 
  ...
  verbVQ v = dirdirV (lin V v) ;
  verbVS v = dirdirV (lin V v) ;
  verbVV v = dirdirV (lin V v) ;

  dirdirV : V -> GraspV ;
  dirdirV v = lin GraspV (lin V3 (v ** {c2 = P.accPrep ; c3 = P.datPrep})) ;
